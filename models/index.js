...
User.belongsToMany(Blog, { through: UserBlogs, as: 'blogs_list' })
Blog.belongsToMany(User, { through: UserBlogs, as: 'reading_lists' }) // Blog BelongsToMany User through the junction table UserBlogs
